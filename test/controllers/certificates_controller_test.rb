...
class CertificatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certificate" do
    assert_difference("Certificate.count") do
      post certificates_url, params: { certificate: { course_id: @certificate.course_id, issued_at: @certificate.issued_at, user_id: @certificate.user_id } }
    end
  ...
  test "should update certificate" do
    patch certificate_url(@certificate), params: { certificate: { course_id: @certificate.course_id, issued_at: @certificate.issued_at, user_id: @certificate.user_id } }
